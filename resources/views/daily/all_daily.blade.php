										...
										<td>
											<div class="media">
												...
												<div class="media-body">
													...
													<td><p><a href="{!! route('add_daily', ['id'=>$daily->id]) !!}" class="btn btn-secondary form-control form-group"><span class="glyphicon glyphicon-pencil"></span></a></p></td>
