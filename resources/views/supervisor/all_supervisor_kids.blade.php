                    ...
                    <td>
                      <div class="media">
                        ...
                        <div class="media-body">
                          ...
                          <p class="summary"><h4>{{$kid->group_name}}</h4></p>
                          <td><p><a href="{!! route('view_daily_kids', ['id'=>$kid->id]) !!}" class="btn btn-secondary form-control form-group"><span class="glyphicon glyphicon-pencil"></span></a></p></td>
